        ...
        <div className="w-full flex flex-col">
            ...
            <div className="w-full flex flex-row items-start gap-8">
                <div className="w-1/3 flex flex-col justify-between items-start gap-5">
                    <div className="w-full flex flex-col items-start gap-2 text-[#171520] font-medium text-base">
                        <span>Full Name</span>
                        <input
                            placeholder="Enter Name"
                            className="w-full p-4 pr-6 rounded-md bg-[#F1F1F1] placeholder:text-[#626262]"
                        />
                    </div>
                    <div className="w-full flex flex-col items-start gap-2 text-[#171520] font-medium text-base">
